...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COMMENT='Il valore 0 di foglio ne indica la molteplicità';
...
-- Dump della struttura di tabella pe.pe_mappali_pratiche
CREATE TABLE IF NOT EXISTS `pe_mappali_pratiche` (
  `Pratica` int(10) unsigned NOT NULL,
  `Edificio` int(10) unsigned NOT NULL,
  `Foglio` char(4) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `pe_subalterni_pratiche` (
  `Subalterno` int(4) unsigned NOT NULL,
  `Edificio` int(10) unsigned NOT NULL,
  `EX` enum('EX') DEFAULT NULL,
  PRIMARY KEY (`Edificio`,`Subalterno`),
  CONSTRAINT `ID Foglio Stradario.3` FOREIGN KEY (`Edificio`) REFERENCES `edifici` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
-- Dump della struttura di tabella pe.tec_mappali_pratiche
CREATE TABLE IF NOT EXISTS `tec_mappali_pratiche` (
  `Pratica` char(10) NOT NULL,
  `Edificio` int(10) unsigned NOT NULL,
  `Foglio` char(4) NOT NULL,
  `Mappale` char(6) DEFAULT NULL,
