						...
						<div class="calcolo-sub">
							...
							<div id="pagamenti">
								...
								foreach ($pagamentiOU as $pagamento) {
									...
									echo "addFieldsPagamentoOU($pagamento[Importo], '".(count($data)==3?'versati il '.$data[2].'/'.$data[1].'/'.$data[0]:'')."', $pagamento[ID], $calcolo[ID], 'tec');";
								}
								echo "</script>";
								?>
								<div>
									...
									<button type="button" onclick="aggiungiPagamentoOU(<?= $calcolo['ID'] ?>, 'tec');">Aggiungi pagamento</button>
								</div>
								...
								foreach ($pagamentiCC as $pagamento) {
									$data = explode('-', $pagamento['Data']);
									echo "addFieldsPagamentoCC($pagamento[Importo], '".(count($data)==3?'versati il '.$data[2].'/'.$data[1].'/'.$data[0]:'')."', $pagamento[ID], $calcolo[ID], 'tec');";
								}
								echo "</script>";
								?>
								<div>
									...
									<button type="button" onclick="aggiungiPagamentoCC(<?= $calcolo['ID'] ?>, 'tec');">Aggiungi pagamento</button>
								</div>
							</div>
						</div>
					</div>
